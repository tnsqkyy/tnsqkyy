# Hola, amigo! <img src="./assets/wave.gif" width="35px" height="35px" alt="wave" />
...
- Python for pentesting and network analysis  
- Tools: Wireshark, nmap, tcpdump, metasploit, Burp Suite  
